...
// In production, this would read from the actual JSON file or database
// For now, returning sample data that matches the analysis results
export default function handler(
  req: NextApiRequest,
  res: NextApiResponse<ComparisonData>
) {
  const data: ComparisonData = {
    ...
    financial: {
      gcp: {
        ...
        metrics: {
          pricing_model: 85,
          cost_predictability: 80,
          free_tier: 75,
          discounts: 90,
          billing_transparency: 85
        },
        strengths: [
      ...
      aws: {
        ...
        metrics: {
          pricing_model: 80,
          cost_predictability: 75,
          free_tier: 85,
          discounts: 85,
          billing_transparency: 80
        },
        strengths: [
    ...
    performance: {
      gcp: {
        score: 87.6,
        metrics: {
          compute_performance: 88,
          network_latency: 90,
          storage_throughput: 85,
          database_performance: 87,
          cdn_performance: 88
        },
        strengths: [
      ...
      aws: {
        score: 88.6,
        metrics: {
          compute_performance: 90,
          network_latency: 85,
          storage_throughput: 88,
          database_performance: 90,
          cdn_performance: 90
        },
        strengths: [
    ...
    scalability: {
      gcp: {
        ...
        metrics: {
          ...
          load_balancing: 90,
          service_limits: 80,
          multi_region_support: 85,
          serverless_scaling: 92
        },
        strengths: [
      ...
      aws: {
        ...
        metrics: {
          ...
          load_balancing: 88,
          service_limits: 85,
          multi_region_support: 90,
          serverless_scaling: 88
        },
        strengths: [
